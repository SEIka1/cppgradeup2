...
#include <vector>
#include <string>
std::vector<unsigned int> finding_password(unsigned int begin, unsigned int end, unsigned int real_key)
{
...
int main()
{
    ...
    {
        std::cout << "Error: begining must be less than end of out range or equal to it.\n";
        return 1;
    }

    std::vector<unsigned int> result_script_massive = finding_password(begin_int, end_int, real_key);
